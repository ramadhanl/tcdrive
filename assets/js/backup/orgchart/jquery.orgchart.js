(function($) {
    ...
    function Node(data){
        ...
        this.formatNode = function(opts){
            ...
            if(typeof data.name !== 'undefined'){
                var fotoString = '<p class="centered"><img src="http://localhost/vegapunk/assets/img/profile_pict/'+self.data.id+'.jpg" class="img-circle" width="60"></p>';
            }
            ...
            return "<div class='node' node-id='"+this.data.id+"'>"+nameString+fotoString+descString+buttonsHtml+"</div>";
        }
    }
